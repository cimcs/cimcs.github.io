...
{% endif %} *{{pub.year}}* [![pdf](/images/pdf.png){:height="17px" width="15px"} Paper ]({% if pub.internal %}{{pub.url | prepend: site.baseurl}}{% else %}{{pub.url}}{% endif %}) <!-- {% if pub.doi %}[[doi]({{pub.doi}})]{% endif %} --> {% if pub.web %} [![project](/images/project.png){:height="21px" width="21px"} Webpage ]({{pub.web}}){% endif %} {% if pub.code %} [![code](/images/code.png){:height="21px" width="21px"} Code]({{pub.code}}){% endif %} {% if pub.demo %}[![demo](/images/demo.png){:height="21px" width="21px"} Demo]({{pub.demo}}){% endif %} {% if pub.video %}[![video](/images/video.png){:height="21px" width="20px"} Video]({{pub.video}}){% endif %} {% if pub.slides %}[![slides](/images/slides.png){:height="18px" width="16px"} Slides]({{pub.slides}}){% endif %}<br />{% if pub.mark %} ({{pub.mark}}){% endif %}
...
## Impacts
- Security advisories and CVEs caused by SmashEx attack in SGX can be found on [**Intel**](https://www.intel.com/content/www/us/en/security-center/advisory/intel-sa-00548.html), [**Microsoft**](https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-33767).
- SmashEx has received podcast reports by Chips & Salsa from Intel (see [**here**](https://blogs.intel.com/technology/2021/10/intel-security-advisories-for-october-2021/)) and more than 100 media coverage world-wide.
